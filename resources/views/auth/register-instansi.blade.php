...
<div class="text-center mb-8">
    <h2 class="text-2xl font-bold text-slate-900">Registrasi Admin Instansi</h2>
    <p class="mt-2 text-sm text-slate-500">Daftarkan instansi atau sekolah Anda untuk memantau perkembangan siswa.</p>
</div>

<!-- Opsi Daftar Google -->
<a href="{{ route('google.redirect', ['role' => 'admin']) }}" class="w-full flex items-center justify-center gap-3 px-4 py-3.5 mb-6 border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-colors text-slate-700 font-semibold text-sm">
...
<div class="relative mb-6">
    ...
    <div class="relative flex justify-center text-sm">
        <span class="px-3 bg-white text-slate-500">Atau daftar instansi manual</span>
    </div>
</div>
