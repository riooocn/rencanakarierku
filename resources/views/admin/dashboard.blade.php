...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-8">
    ...
    <div class="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col md:flex-row md:items-center">
        ...
        <div>
            <p class="text-xs md:text-sm font-medium text-slate-500 mb-1">Total Siswa Aktif</p>
            <h4 class="text-xl md:text-2xl font-bold text-slate-900">{{ $pesertaCount }}</h4>
        </div>
    </div>
    ...
    <div class="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col md:flex-row md:items-center">
        ...
        <div>
            <p class="text-xs md:text-sm font-medium text-slate-500 mb-1">Selesai Tes</p>
            <h4 class="text-xl md:text-2xl font-bold text-slate-900">{{ $siswaSelesaiTesCount }}</h4>
        </div>
    </div>

    <!-- Card 3 -->
    <div class="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col md:flex-row md:items-center">
        <div class="w-10 h-10 md:w-14 md:h-14 rounded-xl bg-yellow-50 flex justify-center items-center text-yellow-600 mb-3 md:mb-0 md:mr-4">
            <svg class="w-5 h-5 md:w-7 md:h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
        </div>
        <div>
            <p class="text-xs md:text-sm font-medium text-slate-500 mb-1">Menunggu Verifikasi</p>
            <h4 class="text-xl md:text-2xl font-bold text-slate-900">{{ $pendingPesertaCount }}</h4>
        </div>
    </div>

    <!-- Card 4 -->
    <div class="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col md:flex-row md:items-center">
        <div class="w-10 h-10 md:w-14 md:h-14 rounded-xl bg-primary-50 flex justify-center items-center text-primary-600 mb-3 md:mb-0 md:mr-4">
            <svg class="w-5 h-5 md:w-7 md:h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
        </div>
        <div>
            <p class="text-xs md:text-sm font-medium text-slate-500 mb-1">Rata-rata Waktu Tes</p>
            <h4 class="text-xl md:text-2xl font-bold text-slate-900">45 Menit</h4>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
    <div class="flex justify-between items-center mb-6 gap-2">
        <h3 class="font-bold text-slate-900 text-sm md:text-base leading-snug">Pendaftaran Siswa Baru (Menunggu Verifikasi)</h3>
        <a href="{{ route('admin.peserta.index') }}" class="text-[11px] md:text-sm text-primary-600 font-medium hover:underline shrink-0 text-right">Kelola Semua Siswa &rarr;</a>
    </div>
