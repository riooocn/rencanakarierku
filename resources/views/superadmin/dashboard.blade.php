...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center">
        <div class="w-14 h-14 rounded-xl bg-purple-50 flex justify-center items-center text-purple-600 mr-4">
    ...
    <!-- Card 4 -->
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center">
        <div class="w-14 h-14 rounded-xl bg-red-50 flex justify-center items-center text-red-600 mr-4">
            <svg class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
    <div class="flex justify-between items-center mb-6">
        <h3 class="font-bold text-slate-900">Pendaftaran Admin Instansi Terbaru</h3>
        <a href="{{ route('superadmin.admin.index') }}" class="text-sm text-primary-600 font-medium hover:underline">Kelola Admin &rarr;</a>
    </div>
