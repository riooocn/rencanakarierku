        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 relative z-10 space-y-8">
            ...
            <div class="bg-white/80 backdrop-blur-xl border border-white shadow-xl shadow-slate-200/50 rounded-3xl p-8 md:p-10 overflow-hidden relative">
                ...
                <div class="flex justify-end items-center pt-6 border-t border-slate-100">
                    <a href="{{ $isKapasitasUpToDate ? route('asesmen.kapasitas.hasil') : route('asesmen.kapasitas') }}" class="inline-flex items-center justify-center px-6 py-3 bg-primary-600 text-white font-semibold rounded-xl hover:bg-primary-700 transition-colors shadow-lg shadow-primary-600/30 group">
                        {{ $isKapasitasUpToDate ? 'Lihat Hasil Kapasitas' : 'Lanjut Tes Kapasitas' }}
